...
class SessionMateUtils {
  void allowDataCapture({required bool allowDataCapture}) {
    locator<ConfigurationService>().allowDataCapturing(allowDataCapture);
  }
  ...
  static Future<void> saveSession({
    ...
    final configService = locator<ConfigurationService>();

    if (!configService.allowDataCapture) {
      return;
    }
