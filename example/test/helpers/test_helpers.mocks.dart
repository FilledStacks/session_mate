...
import 'package:example/services/dio_service.dart' as _i13;
import 'package:example/services/http_service.dart' as _i12;
...
class MockHttpService extends _i1.Mock implements _i12.HttpService {
  ...
  @override
  _i5.Future<String> getResourcesInformation() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i5.Future<String> getCharacters() => (super.noSuchMethod(
        Invocation.method(
          #getCharacters,
          [],
        ),
  ...
  @override
  _i5.Future<String> getLocations() => (super.noSuchMethod(
        Invocation.method(
          #getLocations,
          [],
        ),
  ...
  @override
  _i5.Future<String> getEpisodes() => (super.noSuchMethod(
        Invocation.method(
          #getEpisodes,
          [],
        ),
...
class MockDioService extends _i1.Mock implements _i13.DioService {
  ...
  @override
  _i5.Future<String> getResources() => (super.noSuchMethod(
        Invocation.method(
          #getResources,
          [],
        ),
